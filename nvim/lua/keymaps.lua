...
local motions = safe_require("motions")
	or {
		smart_w_normal = function()
			vim.cmd("normal! w")
		end,
		smart_w_visual = function()
			vim.cmd("normal! w")
		end,
		smart_w_operator = function()
			return "w"
		end,
		smart_b_normal = function()
			vim.cmd("normal! b")
		end,
		smart_b_visual = function()
			vim.cmd("normal! b")
		end,
		smart_b_operator = function()
			return "b"
		end,
		lsp_supports = function()
			return false
		end,
...
map('i', '<M-h>', '<Left>', { noremap = true, silent = true})
map("n", "J", function()
	n_vis("j")
end, { noremap = true, silent = true, desc = "Visual ↓" })
map("x", "J", function()
...
map('i', '<M-j>', '<Down>', { noremap = true, silent = true})
map("n", "K", function()
	n_vis("k")
end, { noremap = true, silent = true, desc = "Visual ↑" })
map("x", "K", function()
...
map('i', '<M-k>', '<Up>', { noremap = true, silent = true })
map("n", "L", function()
	n_vis("l")
end, { noremap = true, silent = true, desc = "Visual →" })
map("x", "L", function()
...
map('i', '<M-l>', '<Right>', { noremap = true, silent = true})
