...
const class_order_async_v3_js_1 = require("./class-order.async.v3.js");
...
(0, synckit_1.runAsWorker)(async ({ classes, configPath, cwd, tsconfigPath }) => {
    ...
    const classOrder = (0, class_order_async_v3_js_1.getClassOrder)(context, classes);
    return { classOrder, warnings: [...warnings] };
});
//# sourceMappingURL=class-order.async.worker.v3.js.map